...
namespace AplicacionVentas.Server
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<AplicacionVentasContext>(options =>
            options.UseNpgsql(Configuration.GetConnectionString("DefaultConnection")));

            //servivio Identity
            services.AddIdentity<IdentityUser, IdentityRole>()
             .AddEntityFrameworkStores<AplicacionVentasContext>()
            ...
            //Servicio para almacenar imagenes en AzureStorage
            //services.AddScoped<IAlmacenadorArchivos, AlmacenadorArchivosAzStorage>();

            //Servicio para almacenar imagenes en Local
